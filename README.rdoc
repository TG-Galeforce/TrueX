This is a short, sample Rails app for screening with TrueX.
Production: https://hidden-basin-2287.herokuapp.com/

Prompt:

Creating your flavor of a Twitter Clone using Rails!
...
·  Visiting the home page defaults to a user page with the last 20 tweets from @trueX
...
·  Make it pretty however you wish :)

·  Tests! (doesn't have to be 100% coverage)

·  Send me the URL and github repo once you're done